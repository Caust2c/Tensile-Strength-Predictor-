...
# Train AdaBoost model with Decision Tree base
model = AdaBoostRegressor(
    estimator=DecisionTreeRegressor(max_depth=4),  # use 'estimator' instead of 'base_estimator'
    n_estimators=100,
    learning_rate=0.1,
    random_state=42
)
...
plt.title("Predicted vs Actual Tensile Strength (AdaBoost)", fontsize=14)
...
plt.savefig('tensile_strength_prediction_adaboost.png')
plt.show()
